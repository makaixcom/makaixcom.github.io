import{_ as s,c as n,o as a,a as l}from"./app.4bcbd411.js";const D=JSON.parse('{"title":"\u8BBE\u7F6E\u73AF\u5883\u53D8\u91CF","description":"","frontmatter":{},"headers":[],"relativePath":"devops/linux/openjdk-install.md"}'),p={name:"devops/linux/openjdk-install.md"},e=l(`<div class="language-"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">sudo yum install java-11-openjdk-devel</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,1),o=[e];function c(t,i,r,A,C,d){return a(),n("div",null,o)}var y=s(p,[["render",c]]);export{D as __pageData,y as default};
